...
import { ArrowCounterclockwise24Regular, Star24Regular } from '@vicons/fluent'
      ...
      <n-page-header>
        <template #title>
          <n-flex align="center" :size="8" :wrap="false">
            <n-icon size="24" color="var(--n-primary-color)"><Star24Regular /></n-icon>
            <n-text strong style="font-size: 18px;">收藏本</n-text>
          </n-flex>
        </template>
        <template #extra>
